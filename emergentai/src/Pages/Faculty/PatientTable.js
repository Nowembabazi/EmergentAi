...
const PatientTable = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const fetchedPatients = Array.from({ length: 12 }, (_, index) => ({
        id: index + 1,
        ...
        <main className="flex-1 p-12 overflow-auto">
          <div className="bg-white rounded-lg shadow-md p-8 mx-auto max-w-5xl">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr>
                  <th className="p-2 bg-gray-200">PatientID</th>
                  <th className="p-2 bg-gray-200">Full Name</th>
                  <th className="p-2 bg-gray-200">Last Visit</th>
                  <th className="p-2 bg-gray-200">History</th>
                  <th className="p-2 bg-gray-200">Result</th>
                  <th className="p-2 bg-gray-200">Next Visit</th>
                  <th className="p-2 bg-gray-200">Action</th>
                </tr>
              </thead>
              ...
              <tbody>
                {currentPatients.map((patient) => (
                  <tr key={patient.id} className="border-t">
                    <td className="p-2">{patient.id.toString().padStart(2, "0")}</td>
